...
_list=(kdelibs kdebase kdeaccessibility kdeutils kdemultimedia kdeadmin kdeartwork kdegames kdetoys kdeedu kdepim kdesdk kdeaddons kdevelop kdewebdev kdegraphics kdenetwork)
for i in ${_list[@]}; do
	echo ${i}
	pushd ${i}
		[[ -f PKGBUILD ]] || continue;
